...
class htmlMimeMail5
{
    ...
    */
    public function __construct()
    {
        ...
        */
        ...
        $this->build_params['html_charset']  = 'cp1251';
        $this->build_params['text_charset']  = 'cp1251';
        $this->build_params['head_charset']  = 'cp1251';
    ...
    */
    public function setTextCharset($charset = 'cp1251')
    {
    ...
    * @param string $charset Character set to use
    */
    public function setHTMLCharset($charset = 'cp1251')
    {
    ...
    * @param string $charset Character set to use
    */
    public function setHeadCharset($charset = 'cp1251')
    {
    ...
    */
    private function encodeHeader($input, $charset = 'KOI8-R')
    {

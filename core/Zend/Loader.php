...
class Zend_Loader
{
    ...
    {
    	 if(shouldLog())
    	 	fdumpFile("loadFile.txt",$filename);
    ...
    /**
     *  maybe send a message to admin about this error? or store in db?
     */

...
class Zend_Session extends Zend_Session_Abstract
{
     ...
     * @var array
     */
    private static $_defaultOptions = array('save_path' => null , 'name' => null, /* this should be set to a unique value for each application */
        'save_handler' => null , //'auto_start'                => null, /* intentionally excluded (see manual) */
     ...
     * @var array
     */
    private static $_localOptions = array('strict' => '_strict' , 'remember_me_seconds' => '_rememberMeSeconds');
    /**
    ...
    {
        session_set_save_handler(array(&$interface , 'open'), array(&$interface , 'close'), array(&$interface , 'read'), array(&$interface , 'write'), array(&$interface , 'destroy'), array(&$interface , 'gc'));
    }
    /**

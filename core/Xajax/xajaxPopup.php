...
class xajaxPopup
{
    ...
    public function getOpen()
    {
        ...
        $this->_page->Template->assign('width', $this->width);
        $this->_page->Template->assign('height', $this->height);
        ...
        $html_code = $this->_page->Template->getContents('_design/ajax_popup/main_popup.tpl');

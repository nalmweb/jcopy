...
class xajaxResponse
{
	 ...
	 */
	/**
	 * @public string internal XML storage
	 */	
	public $xml;
	/**
	 * @public string the encoding type to use
	 */
	public $sEncoding;
	/**
	 * @public boolean if special characters in the XML should be converted to
	 *              entities
	 */
	 ...
	 * 
	 * <i>Usage:</i> <kbd>$objResponse->addScript("public x = prompt('get some text');");</kbd>
	 * 
	 ...
	 *               etc.)
	 * @param string the name to be assigned to the new input and the publiciable
	 ...
	 */
	function _buildObjXml($public) {
		if (gettype($public) == "object") $public = get_object_publics($public);
		if (!is_array($public)) {
			return "<![CDATA[$public]]>";
		}
		else {

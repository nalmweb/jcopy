function fileQueueError(fileObj, error_code, message) {
	try {
		...
		AddImage( image_name, null, "images/");
...
function uploadSuccess(fileObj, server_data) {
	try {
		...
		AddImage(server_data, fileObj, "/swfupload/thumbnail/?id=");
...
function AddImage(src, fileObj, pathTo) {
    ...
    block.appendChild(new_img);
	document.getElementById("thumbnails").appendChild(block);
	if (new_img.filters) {
		try {
	...
	new_img.src = pathTo + src;
	if (null !== fileObj){
	   new_img.title = fileObj.name;
	   
	   var fileName = document.createElement("div");
	    fileName.style.weight = "bold";
        fileName.style.color = "red";
        fileName.innerHTML = fileObj.name;
	   
	   var ppdiv = document.createElement("span");
       ppdiv.innerHTML = ' Make Primary';
        
	   var primaryPhoto = document.createElement("input");
        primaryPhoto.type = 'radio';
        primaryPhoto.name = 'pp';
        primaryPhoto.id = 'pp';
        primaryPhoto.value = src;
        primaryPhoto.checked = '';
	   
       block.appendChild(fileName);
       block.appendChild(br);
       block.appendChild(primaryPhoto);
       block.appendChild(ppdiv);
       
//	   mp = document.getElementById("primaryPhoto");
//	   mp.options.add(new Option(fileObj.name, src));
	}
}

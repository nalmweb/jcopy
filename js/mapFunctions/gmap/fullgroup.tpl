...
map.setCenter(center, {/literal}{$zoom}{literal});
		...
		{literal}
			...
			var point = new GLatLng({/literal}{$m->latitude}{literal},{/literal}{$m->longitude}{literal});
			map.addOverlay(createMarker(point, '{/literal}{$m->login}{literal}', '{/literal}{$m->getAvatar()->getSmall()}{literal}'));

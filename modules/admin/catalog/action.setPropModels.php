<?php
  if (!$this->_page->_user->isAuthenticated()) {
   ...
   $this->_page->Xajax->registerUriFunction("SMchangeModel","/admin/SMchangeModel/");

   $this->_page->Xajax->registerUriFunction("setBikeCategories","/admin/setBikeCategories/");
   $this->_page->Xajax->registerUriFunction("saveData","/admin/saveModelProperties/");
   //set html elements
   ...
   $this->_page->Template->assign('bodyContent', 'admin/catalog/modelsProperties.tpl');

$this->_page->Template->assign('menuTab','catalog');
$this->_page->Template->assign('menuPodTab','setPropModels');

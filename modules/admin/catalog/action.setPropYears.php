<?php
  if (!$this->_page->_user->isAuthenticated()) {
   ...
   $this->_page->Xajax->registerUriFunction("changeModification","/ajax/changeModification/");   
   $this->_page->Xajax->registerUriFunction("changeYear","/admin/changeYear/");

   $this->_page->Xajax->registerUriFunction("loadModificationProperty","/admin/loadModificationProperty/");
   ...
   $this->_page->Xajax->registerUriFunction("saveData","/admin/saveYearProperties/");
   //set html elements
   ...
   $this->_page->Template->assign('bodyContent', 'admin/catalog/yearsProperties.tpl');

$this->_page->Template->assign('menuTab','catalog');
$this->_page->Template->assign('menuPodTab','setPropYears');
